...
"""""MAPPINGS"""""
nnoremap <c-p> yy<c-w>wp<c-w>wj
tnoremap <c-p> <Up><C-\><C-n>:sleep 100m<CR>02Wy$<c-w>wo<Esc>p<c-w>w
vnoremap <c-p> y<c-w>wo<Esc>p<c-w>w
...
autocmd BufWritePost _vimrc                     normal! mV
